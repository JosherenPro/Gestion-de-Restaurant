              ...
              {filteredItems.map(item => (
                <Card key={item.id} className="flex gap-4 p-4 items-center group">
                  <div className="flex-1">
                    ...
                    <p className="font-bold text-[#FC8A06] mt-2">FCFA{item.price.toFixed(2)}</p>
                  </div>
          ...
          <Card className="p-6 bg-white border-2 border-green-500 shadow-xl rounded-3xl">
            ...
            <div className="mt-10 pt-6 border-t border-dashed border-gray-200 space-y-3">
              <div className="flex justify-between items-center px-2">
                ...
                <span className="text-xl font-black text-[#FC8A06]">FCFA{currentOrder.totalPrice.toFixed(2)}</span>
              </div>
        ...
        {basket.length === 0 ? (
          ...
          <div className="flex flex-col gap-4">
              ...
              {basket.map(item => (
                <div key={item.id} className="flex items-center gap-4 bg-gray-50 p-3 rounded-2xl">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-[10px] text-gray-400 uppercase">FCFA{item.price.toFixed(2)} / unité</p>
                  </div>
            ...
            <div className="mt-4 pt-4 border-t border-dashed space-y-2">
              <div className="flex justify-between text-gray-500 text-sm"><p>Sous-total</p><p>{total.toFixed(0)} FCFA</p></div>
              <div className="flex justify-between text-gray-500 text-sm"><p>Service (Table 12)</p><p>150 FCFA</p></div>
              <div className="flex justify-between text-xl font-black text-[#03081F] mt-2"><p>TOTAL</p><p>{(total + 150).toFixed(0)} FCFA</p></div>
            </div>
        ...
        <div className="fixed bottom-6 left-6 right-6 max-w-sm mx-auto z-40">
          <Button fullWidth onClick={() => setIsBasketOpen(true)} className="h-16 shadow-2xl bg-[#03081F] rounded-2xl border-2 border-white/10">
            ...
            <div className="flex-1 text-left px-4">
              ...
              <p className="font-black text-white">{total.toFixed(0)} FCFA</p>
            </div>
